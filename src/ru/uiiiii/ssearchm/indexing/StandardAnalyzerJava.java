 ...
 * </ul>
 */
public final class StandardAnalyzerJava extends StopwordAnalyzerBase {
  ...
  public StandardAnalyzerJava(Version matchVersion, Set<?> stopWords) {
   ...
   * <a href="#version">above</a>}
   */
  public StandardAnalyzerJava(Version matchVersion) {
  ...
  public StandardAnalyzerJava(Version matchVersion, Reader stopwords) throws IOException {
  ...
  protected TokenStreamComponents createComponents(final String fieldName, final Reader reader) {
    final StandardTokenizerJava src = new StandardTokenizerJava(matchVersion, reader);
    ...
    return new TokenStreamComponents(src, tok) {
      ...
      protected boolean reset(final Reader reader) throws IOException {
        src.setMaxTokenLength(StandardAnalyzerJava.this.maxTokenLength);
